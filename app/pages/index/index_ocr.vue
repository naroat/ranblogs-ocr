		...
		<view class="u-demo-block__content" style="height: 100%">
			...
			<view class="fyFrom" v-show="showFyFrom">
				<view class="originImgBox">
					<audio v-if="nowChooseType == 'audio'" :src="originAudio" style="margin: 50rpx 0" controls></audio>
					<u--image 
					v-else
					:fade="true" 
					:showLoading="true" 
				...
				<view class="textFromBox">
					...
					<u--textarea class="textareaFrom" v-model="textFrom" placeholder="请输入内容" count height="450rpx" maxlength="-1"></u--textarea>
				</view> 
			</view>
			<!-- base -->
			<view class="base-show" v-show="baseShow">
				<view class="base-show-box">
					...
					<view class="base-show-content">
						...
						<p>6.音视频文件大小限制20M</p>
						<p>7.识别音视频相对慢一些,最高用时6分钟，请耐心等待</p>
					</view>
